...
if __name__ == '__main__':
    ...
    optparser.add_option('-f', '--input_file', dest='input_file', help='CSV filename', default='data/simple.csv')
    ...
    file_csv = options.input_file
    iterations = options.iterations
    damping_factor = options.damping_factor
    decay_factor = options.decay_factor

    page_rank = PageRankGraph(file_csv, damping_factor, iterations)
